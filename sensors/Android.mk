...
LOCAL_REQUIRED_MODULES := android.hardware.sensors@1.0-impl_vndk-30.samsung-universal7904

include $(BUILD_SHARED_LIBRARY)

include $(CLEAR_VARS)

LOCAL_MODULE := android.hardware.sensors@1.0-impl_vndk-30.samsung-universal7904
LOCAL_MODULE_TAGS  := optional
LOCAL_VENDOR_MODULE := true

LOCAL_MODULE_PATH_32 := $(TARGET_OUT_PRODUCT)/vendor_overlay/30/lib
LOCAL_MODULE_PATH_64 := $(TARGET_OUT_PRODUCT)/vendor_overlay/30/lib64
LOCAL_MODULE_RELATIVE_PATH := hw
