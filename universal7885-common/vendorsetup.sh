...
git clone --depth=1 https://github.com/eurekadevelopment/Eureka-Kernel-Exynos7885-Q-R-S -b R13-AOSP kernel/samsung/exynos7885
...
git clone https://github.com/eurekadevelopment/android_hardware_samsung -b AOSP-13 hardware/samsung
